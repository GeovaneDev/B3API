    ...
    <div>
      ...
      <div className="container mt-5">
        ...
        <div className="mt-5 text-center">
          ...
          <p className="lead">
            A BrInvestAPI foi criada para fornecer aos desenvolvedores acesso fácil e rápido a dados abrangentes e atualizados do mercado de ações brasileiro. Focando em ser gratuita, código aberto e com dados atualizados.
          </p>
        </div>
      </div>
